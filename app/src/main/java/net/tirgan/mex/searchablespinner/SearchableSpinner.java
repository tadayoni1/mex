...
public class SearchableSpinner extends Spinner implements View.OnTouchListener,
        net.tirgan.mex.searchablespinner.SearchableListDialog.SearchableItem {

    public static final int NO_ITEM_SELECTED = -1;
    private Context _context;
    private List _items;
    private net.tirgan.mex.searchablespinner.SearchableListDialog _searchableListDialog;
    ...
    private void init() {
        ...
        _searchableListDialog = net.tirgan.mex.searchablespinner.SearchableListDialog.newInstance
                (_items);
