package net.tirgan.mex.searchablespinner;
...
public class SearchableListDialog extends DialogFragment implements
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(net.tirgan.mex.R.layout.searchable_list_dialog, null);
        setData(rootView);
        ...
        alertDialog.setPositiveButton(strPositiveButton, _onPositiveClickListener);
        String strNegativeButton = _strNegativeButtonText == null ? "CLOSE" : _strNegativeButtonText;
        alertDialog.setNegativeButton(strNegativeButton, _onNegativeClickListener);
    ...
    public void setNegativeButton(String strNegativeButtonText, DialogInterface.OnClickListener onClickListener) {
        _strNegativeButtonText = strNegativeButtonText;
        _onNegativeClickListener = onClickListener;
    }
    ...
    private void setData(View rootView) {
        ...
        _searchView = (SearchView) rootView.findViewById(net.tirgan.mex.R.id.search);
